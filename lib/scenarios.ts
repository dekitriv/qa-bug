...
import type { BugSpec, FormScenario, FormSlug, PublicFormSummary, SubmitResult } from "@/lib/types";
...
export function buildValidationError(fieldErrors: Record<string, string>): SubmitResult {
  return {
    ok: false,
    status: 400,
